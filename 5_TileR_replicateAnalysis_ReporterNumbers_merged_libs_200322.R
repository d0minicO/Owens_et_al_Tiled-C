...
# output is plot and text file of reporter numbers per merged sample

# CTCF-KO version 22nd March 2020
...
fragFile <- paste0(base, "fragData.txt")
...
write_tsv(reportersBySample,path = paste0(QC_dir, "Numbers_mergedLibs.txt"), append = T, col_names = T)
...
ggsave(p,
       filename=paste0(QC_dir,"reporter_counts_mergedSamples.pdf"),
       width=4,
       height=4)
